...
<ul class="nav top-menu">
    ...
    <li id="header_inbox_bar" class="dropdown">
        ...
        <ul class="dropdown-menu extended inbox">
            ...
            <li>
                <a href="index.html#">
                    <span class="photo"><img alt="avatar" src="public/assets/img/ui-zac.jpg"></span>
                    <span class="subject">
            ...
            <li>
                <a href="index.html#">
                    <span class="photo"><img alt="avatar" src="public/assets/img/ui-divya.jpg"></span>
                    <span class="subject">
            ...
            <li>
                <a href="index.html#">
                    <span class="photo"><img alt="avatar" src="public/assets/img/ui-danro.jpg"></span>
                    <span class="subject">
            ...
            <li>
                <a href="index.html#">
                    <span class="photo"><img alt="avatar" src="public/assets/img/ui-sherman.jpg"></span>
                    <span class="subject">
